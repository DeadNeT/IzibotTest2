    ...
    <div class="container">
      ...
      <h1>Your are welcome!</h1>
          <form method="post" action="./ajax.php">
              <input type="hidden" name="act" value="getcomment">
              <input name="email" type="text" class="input-block-level" placeholder="email" autofocus>
              <input name="homepage" type="text" class="input-block-level" placeholder="homepage" autofocus>
              <input name="text" type="text" class="input-block-level" placeholder="text" autofocus>
